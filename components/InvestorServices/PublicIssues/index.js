...
function PublicIssues() {
  const list = [
    { label: 'PAN', value: false },
    { label: 'App. No.', value: false },
    { label: 'DP/Client ID', value: false },
    { label: 'Account No / IFSC', value: false },
  ];

  return (
    <div className=''>
      <TitleStrip title={'Public Issues'} />

      <div className='flex gap-10 h-[70vh] justify-center items-center '>
        <div className='flex my-4 hover:underline cursor-pointer text-orange-600 hover:text-[#4353ff] text-2xl tracking-wider'>
          Application Status
        </div>

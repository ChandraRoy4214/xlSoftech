...
const One = ({ open, setOpen }) => {
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1> How are investors categorized? </h1>
      ...
      <Collapse isOpened={open === 1} checkTimeout={1000}>
        <div className='flex pl-10 pt-3'>
          <p>
            a) Qualified Institutional Bidders (QIBs) - who are the domestic and
            foreign institutions (which are registered with SEBI) which are
            eligible to apply in the public offers. These institutions normally
            apply for very large amounts. b) Retail Investors - The investors
            who invest up to maximum of Rs.2,00,000 (Rs. Two Hundred Thousand),
            are defined as Retail Investors. c) Non Institutional Investors -
            Those Investors who are neither in the QIB Category nor in the
            Retail Investor Category are defined as Non Institutional Investors.
            Note: In some IPOs a certain number of shares issued are reserved
            for employees of the issuing company
          </p>
        </div>
      </Collapse>
    </div>
  ...
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1>
          {' '}
          How can you check the status of allotment on the Link Intime web site?
        </h1>
  ...
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1>
          {' '}
          Is there a fixed quota for allotment for each investor category in an
          IPO?
        </h1>
...
const Four = ({ open, setOpen }) => {
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1> Unblocking of funds thru ASBA / UPI modes?</h1>
  ...
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1>
          {' '}
          What are the different types of Investor category can apply in IPO?
        </h1>
  ...
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1>
          {' '}
          What are the special points Investor should take care of while
          applying in an IPO?
        </h1>
...
const Twele = ({ open, setOpen }) => {
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1> What is UPI Mandate request?</h1>
...
const Fourteen = ({ open, setOpen }) => {
  return (
    <div className='border mb-2 p-2'>
      ...
      >
        <h1> Why is your Demat Account No.(DP-ID & Client-ID) Important?</h1>
